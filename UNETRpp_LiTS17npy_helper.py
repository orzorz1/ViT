...
from commons.plot import save_nii, draw, draw1, save_nii_,save_npy
from data.LoadData_npy_norm_LiTS17 import *
...
from config.LiTS17.config_UNETRpp import *
...
class BaseTrainHelper(object):
    ...
    def train(self, model_load = ''):
        get_norm(train_image_list, test_image_list)
        loss_train = []
        loss_val = []
        model = self.model
    ...
    def predct(self, begin, end, model_load):
        ...
        for index in range(begin, end + 1):
            ...
            save_npy(pre, saveImage_name+"_"+str(index))
